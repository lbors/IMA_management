...
@app.route('/listPods', methods = ['GET']) # sem argumentos, o metodo lista os pods do namespace DEFAULT
...
@app.route('/listPods', methods = ['POST']) # namespace é passado como argumento 
def list_pods():
